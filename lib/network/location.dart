...
import 'package:chennai_cabs_dev/elements/search_result_card.dart';
...
class Location {
  ...
  // places name (from autocomplete api call) -> coordinates
  ...
  // distance between two places by place name
